...
use App\Http\Controllers\Admin\HospitalDepartmentController;
use App\Http\Controllers\Admin\HospitalBranchController;
use App\Http\Controllers\Admin\DoctorCareController;
...
use App\Http\Controllers\Admin\HospitalTestPackagesController;
use App\Http\Controllers\Admin\HospitalTestsController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::controller(HospitalDepartmentController::class)->prefix('hospital-departments')->name('hospital.departments.')->group(function () {
        Route::get('index', 'index')->name('index');
    ...
    Route::controller(HospitalBranchController::class)->prefix('hospital-branch')->name('hospital.branch.')->group(function () {
        Route::get('index', 'index')->name('index');
    ...
    Route::controller(DoctorCareController::class)->prefix('doctor-care')->name('doctor.care.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::get('create', 'create')->name('create');
        Route::post('store', 'store')->name('store');
        Route::get('edit/{id}','edit')->name('edit');
    ...
    Route::controller(AppointmentBookingController::class)->prefix('booking')->name('booking.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('reply-message', 'reply')->name('messages.reply');
    ...
    Route::controller(InvestigationController::class)->prefix("investigation")->name("investigation.")->group(function (){
        ...
        Route::post('store','store')->name('store');
        Route::put('status/update','statusUpdate')->name('status.update');
        Route::put('home/service/update','homeServiceUpdate')->name('home.service.update');
        Route::put('update','update')->name('update');
        Route::delete('delete','delete')->name('delete');
    });
    ...
    // Setup Section
    Route::prefix('setup-sections')->name('setup.sections.')->group(function () {
        Route::controller(SetupSectionsController::class)->group(function() {
            ...
            Route::put('bannner/status/update/{slug}','bannerStatusUpdate')->name('banner.status.update');
        });

        Route::controller(JournalController::class)->prefix('journal')->name('journal.')->group(function () {
            // Route::get('index','journalIndex')->name('index');
